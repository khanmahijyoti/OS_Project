...
obj/user/flocktest/flockwriter:     file format elf32-i386
...
4000001f:	8d 83 c0 e1 ff ff    	lea    -0x1e40(%ebx),%eax
...
40000052:	0f 85 90 00 00 00    	jne    400000e8 <main+0xe8>
40000058:	89 de                	mov    %ebx,%esi
4000005a:	85 db                	test   %ebx,%ebx
4000005c:	0f 88 86 00 00 00    	js     400000e8 <main+0xe8>
...
40000072:	0f 85 bb 00 00 00    	jne    40000133 <main+0x133>
40000078:	8b 45 dc             	mov    -0x24(%ebp),%eax
4000007b:	8d 90 52 e0 ff ff    	lea    -0x1fae(%eax),%edx
    asm volatile ("int %2"
40000081:	8d 80 5d e0 ff ff    	lea    -0x1fa3(%eax),%eax
...
400000a3:	75 22                	jne    400000c7 <main+0xc7>
400000a5:	85 c0                	test   %eax,%eax
400000a7:	75 1e                	jne    400000c7 <main+0xc7>
    for (int i = 0; i < 50; i++) { // changed from 100 to 50
400000a9:	83 c7 01             	add    $0x1,%edi
400000ac:	83 ff 32             	cmp    $0x32,%edi
400000af:	74 4e                	je     400000ff <main+0xff>
400000b1:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
400000b4:	ba 0a 00 00 00       	mov    $0xa,%edx
400000b9:	b8 07 00 00 00       	mov    $0x7,%eax
400000be:	89 f3                	mov    %esi,%ebx
...
400000c8:	50                   	push   %eax
400000c9:	57                   	push   %edi
400000ca:	8b 5d dc             	mov    -0x24(%ebp),%ebx
400000cd:	8d 83 50 e2 ff ff    	lea    -0x1db0(%ebx),%eax
400000d3:	50                   	push   %eax
400000d4:	e8 d7 02 00 00       	call   400003b0 <printf>
            exit();
...
400000e8:	8b 5d dc             	mov    -0x24(%ebp),%ebx
400000eb:	83 ec 0c             	sub    $0xc,%esp
400000ee:	8d 83 e4 e1 ff ff    	lea    -0x1e1c(%ebx),%eax
400000f4:	50                   	push   %eax
400000f5:	e8 b6 02 00 00       	call   400003b0 <printf>
        exit();
400000fa:	83 c4 10             	add    $0x10,%esp
400000fd:	eb dd                	jmp    400000dc <main+0xdc>
    asm volatile ("int %2"
400000ff:	b8 0d 00 00 00       	mov    $0xd,%eax
40000104:	b9 04 00 00 00       	mov    $0x4,%ecx
40000109:	89 f3                	mov    %esi,%ebx
4000010b:	cd 30                	int    $0x30
    return errno ? -1 : 0;; // errno ? -1 : 0; 
4000010d:	85 c0                	test   %eax,%eax
4000010f:	75 42                	jne    40000153 <main+0x153>
    asm volatile ("int %2"
40000111:	b8 05 00 00 00       	mov    $0x5,%eax
40000116:	89 f3                	mov    %esi,%ebx
40000118:	cd 30                	int    $0x30
    printf("=====finishing flockwriter=====\n");
4000011a:	8b 5d dc             	mov    -0x24(%ebp),%ebx
4000011d:	83 ec 0c             	sub    $0xc,%esp
40000120:	8d 83 74 e2 ff ff    	lea    -0x1d8c(%ebx),%eax
40000126:	50                   	push   %eax
40000127:	e8 84 02 00 00       	call   400003b0 <printf>
4000012c:	31 c0                	xor    %eax,%eax
4000012e:	83 c4 10             	add    $0x10,%esp
40000131:	eb a9                	jmp    400000dc <main+0xdc>
        printf("ERROR in flockwriter: could not acquire exclusive lock!\n");
40000133:	8b 5d dc             	mov    -0x24(%ebp),%ebx
40000136:	83 ec 0c             	sub    $0xc,%esp
40000139:	8d 83 14 e2 ff ff    	lea    -0x1dec(%ebx),%eax
        printf("ERROR in flockwriter: could not release flock!\n");
4000013f:	50                   	push   %eax
40000140:	e8 6b 02 00 00       	call   400003b0 <printf>
40000145:	b8 05 00 00 00       	mov    $0x5,%eax
4000014a:	89 f3                	mov    %esi,%ebx
4000014c:	cd 30                	int    $0x30
        exit();
4000014e:	83 c4 10             	add    $0x10,%esp
40000151:	eb 89                	jmp    400000dc <main+0xdc>
        printf("ERROR in flockwriter: could not release flock!\n");
40000153:	8b 5d dc             	mov    -0x24(%ebp),%ebx
40000156:	83 ec 0c             	sub    $0xc,%esp
40000159:	8d 83 98 e2 ff ff    	lea    -0x1d68(%ebx),%eax
4000015f:	eb de                	jmp    4000013f <main+0x13f>
...
40000161:	f7 c4 ff ff ff 0f    	test   $0xfffffff,%esp
	jnz	args_exist
40000167:	75 04                	jne    4000016d <args_exist>
...
noargs:
	...
	pushl	$0
40000169:	6a 00                	push   $0x0
	pushl	$0
4000016b:	6a 00                	push   $0x0
...
args_exist:
	/* Jump to the C part. */
	call	main
4000016d:	e8 8e fe ff ff       	call   40000000 <main>

	/* When returning, push the return value on the stack. */
	pushl	%eax
40000172:	50                   	push   %eax

40000173 <spin>:
spin:
	jmp	spin
40000173:	eb fe                	jmp    40000173 <spin>
40000175:	66 90                	xchg   %ax,%ax
...
40000565:	8b b4 82 68 e0 ff ff 	mov    -0x1f98(%edx,%eax,4),%esi
